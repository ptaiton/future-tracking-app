import { Ingredient, Step, Unit } from "../types/Recipe"
...
const recipes: RawRecipe[] = [{
  ...
  id: 'd3aaaff0-ad3d-403b-ae93-67964gb267c8',
  ...
  ingredients: [{
    ...
    id: 'd3adjff0-ad3d-403b-ae93-67964fb267e8',
    name: 'citron',
    quantity: 1,
    unit: Unit.UNIT
  }, {
    id: 'd3adzff0-ad3d-403b-af93-67964fb267e8',
    name: 'sucre',
    quantity: 200,
    unit: Unit.G
  }, {
    id: 'd3adqff0-ad3d-443b-ae93-67964fb267e8',
    name: 'canelle',
    quantity: 0.5,
    unit: Unit.UNIT
  }],
  steps: [{
    id: 'd3adaff0-ad3d-443b-ae93-67464fb267e9',
    stepNumber: 1,
    description: 'Épluchez les pommes et enlevez les pépins.'
  }, {
    id: 'd3adaffa-ad3d-443b-ae93-67464fb267e9',
    stepNumber: 2,
    description: 'Pressez le citron pour récupérer le jus.'
  }, {
    id: 'd3adafqa-ad3d-443b-ae93-67464fb267e9',
    stepNumber: 3,
    description: 'Coupez les pommes en petits dés dans une casserole et faites cuire à feu doux avec le jus de citron.'
  }, {
    id: 'd3adafka-ad3d-443b-ae93-67464fb267e9',
    stepNumber: 4,
    description: 'En fin de cuisson, rajoutez le sucre et la cannelle, et mélangez avec une cuillère en bois.'
  }]
}]
